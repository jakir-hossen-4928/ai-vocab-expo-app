...
import { fetchFavoriteVocabularies, fetchFavoriteResources, toggleVocabularyFavorite, toggleResourceBookmark } from '@/services/favorites';
        ...
        >
            <View style={styles.cardHeader}>
                <View style={styles.cardTitleContainer}>
                    <Text style={[styles.english, { color: colors.text }]}>{item.title}</Text>
                </View>
                <TouchableOpacity onPress={(e) => handleRemoveResource(e, item.id)}>
            ...
            <View style={styles.cardFooter}>
                <TouchableOpacity
                    ...
                    onPress={(e) => handleShareText(e, `Check out this resource: ${item.title} - ${item.description || ''}`)}
                >
