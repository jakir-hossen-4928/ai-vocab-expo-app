...
export default function FavoritesScreen() {
  ...
  const [selectedTab, setSelectedTab] = useState<"words" | "resources">(
    "words"
  );
  ...
  const handleShareWord = useCallback(
  ...
  const handleViewResourceDetails = useCallback(
    (id: string) => {
    ...
    <View style={styles.emptyContainer}>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          router.push(
            selectedTab === "words"
              ? ("/(drawer)/(tabs)/vocabulary" as any)
              : ("/(drawer)/(tabs)/resources" as any)
          )
        }
      >
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <AppHeader title="Favorites" showMenuButton={true} />
      ...
      <View style={styles.tabsContainer}>
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                selectedTab === "words" ? colors.primary : "transparent",
        ...
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                selectedTab === "resources" ? colors.primary : "transparent",
              borderColor: colors.border,
            },
          ]}
      ...
      {/* Content */}
      {error ? (
        <NetworkError colors={colors} onRetry={loadData} message={error} />
      ) : loading ? (
