...
import { addToBookmarks, getBookmarkedResources, removeFromBookmarks } from '@/services/api';
...
export default function ResourcesScreen() {
    ...
    const handleShare = async (item: Resource) => {
        try {
            const shareUrl = `https://ai-vocabulary-coach.netlify.app/resources/${item.slug || item.id}`;
            await Share.share({
